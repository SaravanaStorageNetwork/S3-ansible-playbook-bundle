...
echo $ORIGIN_IMAGE
echo $ORIGIN_VERSION
ORIGIN_IMAGE="registry.access.redhat.com/openshift3/ose"
ORIGIN_VERSION="v3.9"
echo $ORIGIN_IMAGE
echo $ORIGIN_VERSION
...
#oc cluster up  --public-hostname=10.70.43.54   --version=v3.9 --service-catalog=true   --loglevel=2
